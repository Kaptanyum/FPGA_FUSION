...
################################################################
# This is a generated script based on design: BDesign
#
...
proc create_root_design { parentCell } {
  ...
  set GPS [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 GPS ]

  set IMU [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 IMU ]
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports IMU] [get_bd_intf_pins axi_iic_0/IIC]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports GPS] [get_bd_intf_pins axi_uartlite_0/UART]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
